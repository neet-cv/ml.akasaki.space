...
这是一篇关于综述论文的解读。[原论文（A Review on Deep Learning Techniques Applied to Semantic Segmentation）](A-Review-on-Deep-Learning-Techniques-Applied-to-Semantic-Segmentation.pdf)
...
我看了这篇综述受益匪浅，如果有时间的话请阅读[原作](A-Review-on-Deep-Learning-Techniques-Applied-to-Semantic-Segmentation.pdf)。本文只是对原作阅读的粗浅笔记。
